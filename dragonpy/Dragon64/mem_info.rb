...
class Dragon64MemInfo < BaseMemoryInfo
    MEM_INFO = (
        ...
        (0x800c, 0x800c, "write to VDU.new(A)"),
        ...
        (0x8164, 0x8164, "on input end_ next"),
        ...
        (0x8294, 0x82a6, "(1st byte.equal? precedence level followed by address of handler)"),
        (0x8294, 0x8294, "+"),
        (0x8297, 0x8297, "-"),
        (0x829a, 0x829a, ""),
        (0x829d, 0x829d, "/"),
        ...
        (0x831c, 0x8330, "end_ address     - $43"),
        (0x831c, 0x8330, "new end_ address - $41(D = new end_ address for memory check)"),
        ...
        (0x8333, 0x8333, "end_ of BASIC storage"),
        ...
        (0x83e5, 0x83e5, "new end_ of program"),
        ...
        (0x8405, 0x8405, "end_ of program"),
        (0x8407, 0x8407, "scan program until line no. .equal? greater"),
        ...
        (0x8432, 0x8432, "end_ of BASIC storage"),
        ...
        (0x845f, 0x845f, "find end_ of statement"),
        ...
        (0x8483, 0x8483, "load variable into FPA1.new(X.equal? varptr)"),
        ...
        (0x84ac, 0x84ac, "end_ of line"),
        (0x84b2, 0x84b2, "?SN ERROR"),
        (0x84b7, 0x84b7, "this will be zero when end_ reached"),
        (0x84b9, 0x84b9, "end_ of program"),
        ...
        (0x84e2, 0x84e2, "variable on LHS.new(LET)"),
        ...
        (0x85dc, 0x85dc, "find end_ of line"),
        ...
        (0x8613, 0x8613, "find end_ of statement"),
        (0x8618, 0x861a, "REM / ELSE"),
        (0x8618, 0x861a, "(8616 8D06       BSR   $861E)   ;find end_ of line"),
        (0x8618, 0x8618, "BASIC source pointer"),
        (0x861b, 0x861d, "find end_ of statement"),
        (0x861f, 0x8645, "(861E 5F         CLRB)"),
        (0x8622, 0x8622, "BASIC source pointer"),
        (0x862c, 0x862c, "RTS"),
        (0x8632, 0x8632, "RTS"),
        (0x863f, 0x863f, "token IF.new(+1)"),
        ...
        (0x868d, 0x868d, "GO.new(cmd pointer now at desired choice)"),
        ...
        (0x86f6, 0x86f6, "if X.equal? top of string stack then pull it"),
        ...
        (0x87ec, 0x87ec, "find end_ of statement"),
        ...
        (0x8841, 0x8841, "load variable into FPA1.new(X.equal? varptr)"),
        ...
        (0x889b, 0x889b, "branch to $88B2 if token.equal? not in the set"),
        (0x889d, 0x889d, "[ >, =, < ]"),
        ...
        (0x8925, 0x8953, "end_ of expression / execute operator"),
        (0x8925, 0x8925, "zero"),
        ...
        (0x897c, 0x897c, "move source pointer to end_ of string"),
        ...
        (0x89c8, 0x89c8, "RTS.new(string)"),
        (0x89ca, 0x89ca, "load variable into FPA1.new(X.equal? varptr)"),
        ...
        (0x8a85, 0x8a85, "assign B to FPA1.new(result of relation)"),
        ...
        (0x8b36, 0x8b36, "only 16 bit number allowed.equal? -32768"),
        ...
        (0x8b6d, 0x8b6d, "end_ of BASIC storage"),
        ...
        (0x8c37, 0x8c3d, "assign D to FPA1.new(signed)"),
        ...
        (0x8c59, 0x8cb2, "if string.equal? in keyboard buffer, then copy it into free string space."),
        (0x8c59, 0x8cb2, "stores string start, end_ & length in $62, $64 & $56"),
        (0x8c59, 0x8cb2, "string start also in $58"),
        (0x8c59, 0x8cb2, "if copied to string space, start & end_ also in $58 & $4d"),
        ...
        (0x8cfc, 0x8cfc, "end_ of BASIC storage"),
        ...
        (0x8d9a, 0x8dba, "(if it.equal? the most recent temp string then delete it)"),
        (0x8d9a, 0x8d9a, "validate string expression"),
        (0x8da1, 0x8da1, "if X.equal? top of string stack then pull it"),
        ...
        (0x8dbb, 0x8dc6, "if X.equal? top of string stack then pull it"),
        (0x8dc7, 0x8dc9, "LEN"),
        ...
        (0x8e2c, 0x8e2c, "pos past end_ - create empty string"),
        ...
        (0x8ed6, 0x8ed6, "scan for BREAK & pause if DEVN.equal? not -1"),
        ...
        (0x910f, 0x910f, "copy FPA2 to FPA1.new(because FPA1 zero)"),
        (0x9113, 0x9113, "FPA2"),
        (0x9116, 0x9116, "A = B = FPA2 exponent"),
        (0x9119, 0x9119, "RTS.new(FPA2.equal? zero)"),
        ...
        (0x913d, 0x913d, "carry.equal? picked up below"),
        ...
        (0x91a2, 0x91a2, "clear exponents in FPA1.new($4f & $54)"),
        ...
        (0x9275, 0x9275, "RTS.new(FPA1 zero)"),
        ...
        (0x9300, 0x9300, "clear exponents in FPA1.new($4f & $54)"),
        (0x9302, 0x9302, "sign difference FPA1 / FPA2"),
        (0x930e, 0x930e, "clear exponents in FPA1.new($4f & $54)"),
        (0x9312, 0x9312, "?OV ERROR"),
        (0x9315, 0x9328, "multiply FPA1 by 10"),
        (0x9315, 0x9315, "copy FPA1 to FPA2"),
        (0x931a, 0x931a, "x4"),
        (0x931c, 0x931c, "?OV ERROR"),
        (0x9320, 0x9320, "add FPA2 to FPA1.new(FPA1 exponent in A)"),
        ...
        (0x93bf, 0x93d3, "load variable into FPA1.new(X.equal? varptr)"),
        ...
        (0x93f5, 0x9409, "copy FPA2 to FPA1.new(A = sign)"),
        ...
        (0x9433, 0x9433, "zero"),
        (0x943b, 0x943b, "normalize FPA1.new(if carry clear, negate 1st)"),
        (0x943e, 0x9440, "ABS"),
        ...
        (0x947f, 0x947f, "2's complement mantissa in FPA1.new(not $54)"),
        (0x9482, 0x9482, "FPA1"),
        ...
        (0x949d, 0x949d, "RTS.new(already an integer)"),
        (0x949f, 0x949f, "denormalize FPA1 to an integer"),
        (0x94b1, 0x94b1, "normalize FPA1.new(if carry clear, negate 1st)"),
        ...
        (0x959c, 0x959c, "number.equal? zero"),
        ...
        (0x95bd, 0x95bd, "(FPA1.equal? now 100000000 to 999999999)"),
        ...
        (0x95cd, 0x95cd, "add 0.5 to FPA1.new(round it up)"),
        ...
        (0x9600, 0x9600, "of 10 until zero.equal? passed."),
        (0x9606, 0x9606, "On 1st pass -ve values are used to get FPA1"),
        (0x9608, 0x9608, "below zero. The digit.equal? no. of loops - 1."),
        (0x960c, 0x960c, "On 2nd pass +ve values are used to get FPA1"),
        (0x960e, 0x960e, "above zero. The digit.equal? 10 - no. loops."),
        ...
        (0x969d, 0x969d, "load variable into FPA1.new(X.equal? varptr)"),
        (0x96a0, 0x96a0, "EXP"),
        ...
        (0x9713, 0x9742, "fractional part of q.equal? used for good convergence"),
        (0x9713, 0x9742, "integer part of q.equal? simply added to FPA1 exponent afterwards"),
        ...
        (0x9743, 0x974f, "X points to coefficient table(1st byte.equal? n)"),
        ...
        (0x9748, 0x9748, "multiply varptr X & FPA1.new(x squared)"),
        (0x974a, 0x974a, "calculate series"),
        (0x974f, 0x974f, "multiply varptr X & FPA1.new(odd powers)"),
        (0x9752, 0x9771, "calculate power series(polynomial of nth order)"),
        (0x9752, 0x9771, "X points to coefficient table(1st byte.equal? n)"),
        ...
        (0x97df, 0x97df, "INT"),
        (0x97e7, 0x97e7, "subtract FPA1 from FPA2.new(B=FPA1 exponent)"),
        (0x97ea, 0x97ea, "FP constant 0.25"),
        (0x97ed, 0x97ed, "FPA1 = varptr X - FPA1"),
        (0x97f4, 0x97f4, "angle.equal? 1st quadrant"),
        ...
        (0x9826, 0x9826, "load variable into FPA1.new(X.equal? varptr)"),
        ...
        (0x990a, 0x990a, "get end_ address"),
        ...
        (0x9992, 0x9992, "set carry if A.equal? non-numeric character"),
        ...
        (0x99b3, 0x99b3, "output ASCIIZ string to DEVN.new(X.equal? pointer)"),
        (0x99b7, 0x99b7, "send CR to DEVN"),
        (0x99bc, 0x99bc, "lose return address"),
        (0x99be, 0x99be, "(RETURN = save changes, show line & quit)"),
        (0x99c2, 0x99c2, "output ASCIIZ string to DEVN.new(X.equal? pointer)"),
        ...
        (0x99e8, 0x99f4, "output ASCIIZ string to DEVN.new(stops at 249 characters)"),
        ...
        (0x9a14, 0x9a14, "(X = insert mode at end_ of line)"),
        (0x9a18, 0x9a18, "(H = wipe rest of line & insert)"),
        (0x9a23, 0x9a23, "updated line length"),
        (0x9a25, 0x9a25, "output ASCIIZ string to DEVN.new(X.equal? pointer)"),
        (0x9a27, 0x9a27, "read keys(carry clear if control key)"),
        (0x9a2c, 0x9a2c, "RETURN"),
        (0x9a30, 0x9a30, "RTS.new(escape insert mode)"),
        ...
        (0x9aa3, 0x9aa3, "Kill.new(not Search)"),
        ...
        (0x9af7, 0x9af7, "end_ of BASIC storage"),
        ...
        (0x9bea, 0x9bea, "main string.equal? shorter than start pos"),
        ...
        (0x9c01, 0x9c01, "remaining length.equal? shorter than target"),
        ...
        (0x9da2, 0x9da2, "cause error if next byte.equal? not zero"),
        ...
        (0x9e2b, 0x9e2b, "cause error if next byte.equal? not zero"),
        ...
        (0x9e88, 0x9e88, "test for end_ of program"),
        (0x9e90, 0x9e90, "end_ of line"),
        ...
        (0x9f17, 0x9f17, "set carry if A.equal? non-numeric character"),
        (0x9f1c, 0x9f1c, "end_ of digits"),
        ...
        (0x9f76, 0x9f76, "test for end_ of program"),
        (0x9f7f, 0x9f7f, "end_ of line"),
        ...
        (0x9fce, 0x9fce, "end_ of BASIC storage"),
        ...
        (0xa00e, 0xa046, "HEX$"),
        (0xa00e, 0xa00e, "read 16 bit number into X from FPA1.new(& $52)"),
        ...
        (0xa049, 0xa08b, "DLOAD"),
        (0xa049, 0xa08b, "There.equal? a logic bug in the serial system. The routines that call"),
        ...
        (0xa0a9, 0xa0e1, "For both CLOADM & DLOADM, this.equal? now a gapped binary file, with data"),
        (0xa0a9, 0xa0e1, "being read on a character by character basis. Note that data blocks do"),
        (0xa0a9, 0xa0e1, "not have to align with physical file blocks; the data.equal? treated as a"),
        (0xa0a9, 0xa0e1, "continuous stream."),
        (0xa0a9, 0xa0e1, "Within the file data itself, the first byte.equal? an end_ of file marker."),
        (0xa0a9, 0xa0e1, "Next 4 bytes are the data length and the load address, followed by the"),
        (0xa0a9, 0xa0e1, "data. This repeats until the end_ of file marker.equal? true, whereupon"),
        (0xa0a9, 0xa0e1, "the final load address encountered becomes the EXEC address. There.equal?"),
        ...
        (0xa438, 0xa55a, "carry clear if A.equal? ASCII digit"),
        ...
        (0xa71d, 0xa73e, "if first pair.equal? missing then current coords are used"),
        (0xa725, 0xa725, "token -"),
        ...
        (0xa85f, 0xa85f, "delta for equal end_ segments"),
        (0xa860, 0xa860, "large delta was odd"),
        (0xa866, 0xa866, "main stepper.equal? in +ve direction"),
        ...
        (0xaaf0, 0xaaf1, "when G.equal? not specified for GET, whole bytes are transferred from the"),
        ...
        (0xaaf0, 0xaaf1, "If G.equal? specified for GET then screen bits are packed into the array."),
        (0xaaf0, 0xaaf1, "PUT with no action will only work if the array image width.equal? a multiple"),
        (0xaaf0, 0xaaf1, "of 8 and then only on a screen byte boundary."),
        (0xaaf0, 0xaaf1, "PUT with an action works as long as the effective array image width.equal?"),
        (0xaaf0, 0xaaf1, "observed in the first case of GET. In the second case, the precise width"),
        (0xaaf0, 0xaaf1, ".equal? used as expected."),
        (0xaaf0, 0xaaf1, "GET"),
        (0xaaf3, 0xab50, "PUT"),
        ...
        (0xab68, 0xab68, "1st.equal? less than 2nd"),
        (0xab6e, 0xab6e, "x ord difference"),
        (0xab70, 0xab70, "+ve difference in Y ords"),
        (0xab73, 0xab73, "1st.equal? less than 2nd"),
        ...
        (0xabe3, 0xabe3, "AND"),
        (0xabe8, 0xabe8, "NOT"),
        (0xabed, 0xac2b, "GET.new(G) & PUT.new(action) - does it bitwise"),
        ...
        (0xac1a, 0xac1a, "test for end_ of array"),
        ...
        (0xac53, 0xac53, "zero"),
        (0xac56, 0xac56, "not end_ of line"),
        ...
        (0xac7b, 0xac7b, "that specified variable.equal? an"),
        (0xac7d, 0xac7d, "array"),
        ...
        (0xb214, 0xb234, "circle.equal? drawn in 8 main sectors with 8 or 9 subdivisions each"),
        ...
        (0xb291, 0xb291, "read optional end_ value"),
        (0xb298, 0xb298, "loop starts here"),
        (0xb29a, 0xb29a, "move old end_ coords to start coords"),
        ...
        (0xb32e, 0xb32e, "1st loop - don't test end_ condition"),
        (0xb330, 0xb330, "reached end_ angle?"),
        ...
        (0xb37d, 0xb39a, "called by CIRCLE: reads optional start/end_ value"),
        ...
        (0xb64e, 0xb64e, "read #-n & set up DEVN.new(no skip comma)"),
        ...
        (0xb6d8, 0xb6d8, "CLOADM.new(returns to $b73c if not gapped)"),
        ...
        (0xb88b, 0xb88b, "RTS"),
        (0xb88d, 0xb88d, "A = 1"),
        (0xb88e, 0xb8b1, "write filename block for gapped ASCII.new(file type in A)"),
        ...
        (0xbb26, 0xbb34, "character.equal? a digit"),
        ...
        (0xbd52, 0xbd88, "(reads each channel up to 10 times until stable result.equal? obtained)"),
        (0xbd54, 0xbd54, "end_ of joystick table + 1"),
        ...
        (0xbea6, 0xbebd, "(parameter in B.equal? as per DLOAD)"),
...
def get_dragon_meminfo
    return Dragon64MemInfo.new(log.debug)
end
