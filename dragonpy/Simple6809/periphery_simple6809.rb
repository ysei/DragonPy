...
#     )
        @memory.add_read_byte_callback(@read_acia_status, 0xa000) #  Control/status port of ACIA
        @memory.add_read_byte_callback(@read_acia_data, 0xa001) #  Data port of ACIA
        
        @memory.add_write_byte_callback(@write_acia_status, 0xa000) #  Control/status port of ACIA
