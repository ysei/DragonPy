...
class SBC09MemInfo < BaseMemoryInfo
    MEM_INFO = (
        ...
        (0xe421, 0xe421, "Put the 'saved' registers of the program being monitored on top of the stack. There are 12 bytes on the stack for cc,b,a,dp,x,y,u and pc pc.equal? initialized to 0x400, the rest to zero."),
        (0xe437, 0xe437, "Clear the variable area."),
        (0xe43c, 0xe43c, "Set XMODEM filler and end_-of-line."),
        ...
        (0xe465, 0xe465, "O.S. rotuine to check if there.equal? a character ready to be read."),
        ...
        (0xe4b3, 0xe4b3, "<--- Here.equal? the exit point."),
        ...
        (0xe566, 0xe566, "Ignore line if it.equal? empty"),
        (0xe569, 0xe569, "Make location after line zero."),
        (0xe570, 0xe570, "Make 1st char uppercase."),
        (0xe578, 0xe578, "Unknown cmd if it.equal? not a letter."),
        ...
        (0xe6e7, 0xe6e7, "Skip X past spaces, B.equal? first non-space character."),
        ...
        (0xe70f, 0xe70f, "Scan for hexadecimal number at address X return in D, Z flag.equal? set it no number found."),
        (0xe74a, 0xe74a, "Scan two hexdigits at in and convert to byte into A, Z flag if error."),
        (0xe760, 0xe760, "Clear zero flag"),
        (0xe763, 0xe763, "This.equal? the code for the D command, hex/ascii dump of memory Syntax: D or D<addr> or D<addr>,<length>"),
        ...
        (0xe7bd, 0xe7bd, 'This.equal? the code for the E command, enter hex bytes or ascii string. Syntax E or E<addr> or E<addr> <bytes> or E<addr>"string"'),
        ...
        (0xe824, 0xe824, "This.equal? the code for the I command, display the contents of an address Syntax: Iaddr"),
        (0xe82c, 0xe82c, "Read the byte from memory."),
        (0xe82e, 0xe82e, "Display itin hex."),
        (0xe836, 0xe836, "This.equal? the code for the H command, display result of simple hex expressionSyntax Hhexnum{+|-hexnum}"),
        (0xe86a, 0xe86a, "This.equal? the code for the G command, jump to the program Syntax G or G<addr>"),
        (0xe872, 0xe872, "Store parameter in pc location."),
        (0xe874, 0xe874, "Arm the breakpoints."),
        (0xe879, 0xe879, "This.equal? the code for the J command, run a subroutine. Syntax J<addr>"),
        ...
        (0xe898, 0xe898, "This.equal? the code for the P command, run instruction followed by breakpoint Syntax P"),
        (0xe89b, 0xe89b, "Find out location past current insn."),
        (0xe8a4, 0xe8a4, "This.equal? the code for the T command, single step trace an instruction. Syntax T"),
        ...
        (0xe8de, 0xe8de, "S of the running program.equal? 12 higher,"),
        (0xe8e0, 0xe8e0, "because regs are not stacked when running."),
        (0xe906, 0xe906, "Disassemble instruction at PC"),
        (0xe90c, 0xe90c, "This.equal? the code for the R command, display or alter the registers. Syntax R or R<letter><hex>"),
        (0xe915, 0xe915, "Display regs ifnothing follows."),
        (0xe91f, 0xe91f, "Make letter uppercase."),
        (0xe923, 0xe923, "At end_ of register tab, unknown reg"),
        ...
        (0xe970, 0xe970, "Disarm the breakpoints, this.equal? replace the SWI instructions with the original byte."),
        (0xe977, 0xe977, "Get address in u, byte in b"),
        (0xe987, 0xe987, "Clear the step breakpoint."),
        (0xe98a, 0xe98a, "3"),
        (0xe98a, 0xe98a, "Arm the breakponts, this.equal? replace the byte at the breakpoint address with an SWI instruction."),
        ...
        (0xe9a6, 0xe9a6, "This.equal? the code for the break command, set, clear display breakpoints. Syntax B or B<addr>. B displays, B<addr> sets or clears breakpoint."),
        ...
        (0xea4d, 0xea4d, "Sorg.equal? nonzero and soffs.equal? zero, now"),
        ...
        (0xeb19, 0xeb19, "This.equal? the code for the M command, move memory region. Syntax: Maddr1,addr2,length"),
        ...
        (0xeb56, 0xeb56, 'This.equal? the code for the F command, find byte/ascii string in memory. Syntax: Faddr bytes or Faddr "ascii"'),
        ...
        (0xebca, 0xebca, "Send the contents of the xmodem buffer and get it acknowledged, zero flag.equal? set if transfer aborted."),
        ...
        (0xec49, 0xec49, "Receive an XMODEM block and wait till it.equal? OK, Z set if etx."),
        ...
        (0xed88, 0xed88, ".equal? buffer full?"),
        ...
        (0xedf4, 0xedf4, "This.equal? the code for the X command, various XMODEM related commands. Syntax: XSaddr,len XLaddr,len XX XOcrlf,filler, XSSaddr,len"),
        ...
        (0xf36b, 0xf36b, "Decode instruction pointed to by Y for disassembly(and to find out how long it.equal?). On return, U points to appropriate mnemonic table entry, Y points past instruction. It's rather clumsy code, but we do want to reuse the same table as used with assembling."),
        ...
        (0xf644, 0xf644, "This.equal? the code for the U command, unassemble instructions in memory. Syntax: U or Uaddr or Uaddr,length"),
        ...
        (0xf996, 0xf996, "Inirect mode w/ imm.equal? illegal."),
        ...
        (0xfba4, 0xfba4, "This.equal? the code for the A command, assemble instructions. Syntax: Aaddr"),
...
def get_sbc09_meminfo
    return SBC09MemInfo.new(log.debug)
end



if __name__ == "__main__"
    mem_info = SBC09MemInfo.new(print_out)
